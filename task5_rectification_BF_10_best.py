...
img1 = cv2.imread('bL.jpeg',0)  #queryimage # left image
img2 = cv2.imread('bR.jpeg',0) #trainimage # right image
...
#initiate SIFT (scale-invaraint feature transform). It'll detect keypoinys
# sift = cv2.SIFT_create(contrastThreshold = 0.01)
# sift = cv2.xfeatures2d.HarrisLaplaceFeatureDetector_create()
...
print('aa')
print(des1)
#change format into float32 for alter computation
...
matches = bf.knnMatchImpl(des1,des2, k=2)
